...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post pieces_url, params: { piece: { description: @piece.description, image: @piece.image, name: @piece.name } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { description: @piece.description, image: @piece.image, name: @piece.name } }
